    ...
    <div className={styles.detail}>
      <div className={styles.row}>
        <InputControl
          label="Title"
          value={values.title}
          placeholder="Enter title eg. Diploma/B-tech"
          onChange={(event) =>
            setValues((prev) => ({ ...prev, title: event.target.value }))
          }
        />
  ...
  const basicInfoBody = (
    <div className={styles.detail}>
      <div className={styles.row}>
        <InputControl
          label="Name"
          placeholder="Enter your full name eg. Sayem"
          value={values.name}
          onChange={(event) =>
        ...
        <InputControl
          ...
          placeholder="Enter your address eg.New Delhi"
          onChange={(event) =>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.body}>
          <InputControl
            ...
            value={sectionTitle}
            onChange={(event) => setSectionTitle(event.target.value)} //edit on title
          />
